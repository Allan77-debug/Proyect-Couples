...
# Hall of Fame
btn_fama = Button(win, text="Salón de la Fama", font=fontName, width=25, height=3, command=fame, bg="#FFFFFF", bd=0, highlightthickness=0)
btn_fama.grid(row=6, column=2, columnspan=2, padx=15)
btn_fama.bind("<Enter>", on_enter)
btn_fama.bind("<Leave>", on_leave)
