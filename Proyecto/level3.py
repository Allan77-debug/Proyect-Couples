...
def start(t, name):
    ...
    # Images
    if t == "1":
        img1 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 1.jpg").resize((175, 125)))
        img2 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 2.jpg").resize((175, 125)))
        img3 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 3.jpg").resize((175, 125)))
        img4 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 4.jpg").resize((175, 125)))
        img5 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 5.jpg").resize((175, 125)))
        img6 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 6.jpg").resize((175, 125)))
        img7 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 7.jpg").resize((175, 125)))
        img8 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 8.jpg").resize((175, 125)))
        img9 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 9.jpg").resize((175, 125)))
        img10 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 10.jpg").resize((175, 125)))
        img11 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 11.jpg").resize((175, 125)))
        img12 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 12.jpg").resize((175, 125)))
        img13 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 13.jpg").resize((175, 125)))
        img14 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 14.jpg").resize((175, 125)))
        img15 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 15.jpg").resize((175, 125)))
        qmark = ImageTk.PhotoImage(Image.open("Images/questionmark.jpg").resize((175, 125)))
    elif t == "2":
        img1 = ImageTk.PhotoImage(Image.open("Images/superheroes/Ant-man.jpg").resize((175, 125)))
        img2 = ImageTk.PhotoImage(Image.open("Images/superheroes/Black-Widow.jpg").resize((175, 125)))
        img3 = ImageTk.PhotoImage(Image.open("Images/superheroes/Capitan-America.jpg").resize((175, 125)))
        img4 = ImageTk.PhotoImage(Image.open("Images/superheroes/Capitana-Marvel.jpg").resize((175, 125)))
        img5 = ImageTk.PhotoImage(Image.open("Images/superheroes/Doctor-Strange.jpg").resize((175, 125)))
        img6 = ImageTk.PhotoImage(Image.open("Images/superheroes/Gamora.jpg").resize((175, 125)))
        img7 = ImageTk.PhotoImage(Image.open("Images/superheroes/Hulk.jpg").resize((175, 125)))
        img8 = ImageTk.PhotoImage(Image.open("Images/superheroes/Iron-Man.jpg").resize((175, 125)))
        img9 = ImageTk.PhotoImage(Image.open("Images/superheroes/Pantera-Negra.jpg").resize((175, 125)))
        img10 = ImageTk.PhotoImage(Image.open("Images/superheroes/Spiderman.jpg").resize((175, 125)))
        img11 = ImageTk.PhotoImage(Image.open("Images/superheroes/Starlord.jpg").resize((175, 125)))
        img12 = ImageTk.PhotoImage(Image.open("Images/superheroes/Thor.jpg").resize((175, 125)))
        img13 = ImageTk.PhotoImage(Image.open("Images/superheroes/Vision.jpg").resize((175, 125)))
        img14 = ImageTk.PhotoImage(Image.open("Images/superheroes/Wanda.jpg").resize((175, 125)))
        img15 = ImageTk.PhotoImage(Image.open("Images/superheroes/Loki.jpg").resize((175, 125)))
        qmark = ImageTk.PhotoImage(Image.open("Images/questionmark.jpg").resize((175, 125)))
    elif t == "3":  
