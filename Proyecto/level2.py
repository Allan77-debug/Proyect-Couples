...
def start(t):
    ...
    if t == "1":
        ...
        img9 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 9.jpg").resize((250, 150)))
        img10 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 10.jpg").resize((250, 150)))
        img11 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 11.jpg").resize((250, 150)))
        img12 = ImageTk.PhotoImage(Image.open("Images/Paisajes/Paisaje 12.jpg").resize((250, 150)))
        qmark = ImageTk.PhotoImage(Image.open("Images/questionmark.jpg").resize((250, 150)))
